...
//B5 should always be SCK(spi clock) and B3 should always be MOSI. If you are using
//an
//SPI peripheral that sends data back to the arduino, you will need to use B4 as
//the MISO pin.
...
//account.
void SPI_INIT(){
DDRB |= (1 << PIN_SCK) | (1 << PIN_MOSI) | (1 << PIN_SS);//initialize your
//pins.
